...
const Contact = () => {
        ...
        <section className="relative bg-[url('/images/profile.jpg')] bg-contain  py-20 bg-gray-900 text-white text-center">
            {/* <div className="absolute inset-0 bg-gradient-to-l from-black/45 to-gray-900"></div> */}
        <h2 className="text-4xl font-bold mb-10">Contact Me</h2>
        <form className="max-w-md mx-auto flex flex-col gap-4 bg-gray-800 opacity-70 p-6 rounded-lg shadow-lg">
